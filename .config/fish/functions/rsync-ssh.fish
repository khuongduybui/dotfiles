...
function rsync-ssh
    ...
    and bash ~/setup/backup-and-link.sh ~/winhome/Insync/duy@buifamily.info/OneDrive/Essentials/dotfile.ssh ~/.ssh

    test -d ~/winhome/.ssh
    and bash ~/setup/backup-and-link.sh ~/winhome/.ssh ~/.ssh

...
abbr dc 'docker compose -f $backend/aerss/docker-compose.yml'
abbr dcps 'docker compose -f $backend/aerss/docker-compose.yml ps'
abbr dcb '$backend/build/aerss/docker_compose_build.sh'
abbr dce 'docker compose -f $backend/aerss/docker-compose.yml exec'
abbr dcl 'docker compose -f $backend/aerss/docker-compose.yml logs'
abbr up 'docker compose -f $backend/aerss/docker-compose.yml up'
abbr down 'docker compose -f $backend/aerss/docker-compose.yml down -v --remove-orphans'
